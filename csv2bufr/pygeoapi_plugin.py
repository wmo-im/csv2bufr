...
PROCESS_METADATA = {"version": "0.0.1",
    "id": "csv2bufr",
    "title": {"en": "csv2bufr",
    },
    "description": {"en": "Process to convert CSV data to BUFR",
    },
    "keywords": [],
    "links": [
        {"type": "text/html",
    ...
    "inputs": {"data": {"title": "CSV Data",
            "description": "Input CSV file contents as string.",
            "schema": {"type": "string"},
            "minOccurs": 1,
            "maxOccurs": 1,
            "metadata": None,
        ...
        "mapping": {"title": "BUFR Mapping",
            "description": "JSON file describing BUFR mapping.",
            "schema": {"type": "string"},
            "minOccurs": 1,
            "maxOccurs": 1,
            "metadata": None,
    ...
    "outputs": {"messages": {"title": "BUFR encoded data in base64",
            "schema": {"type": "array"},
            "description": "One result per line in input data"
        }
    },
    "example": {
        "inputs": {
